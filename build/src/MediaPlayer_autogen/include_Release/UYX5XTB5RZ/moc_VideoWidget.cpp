...
void VideoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->seekFrameReady(); break;
        case 1: _t->onRenderTick(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (VideoWidget::*)()>(_a, &VideoWidget::seekFrameReady, 0))
            return;
    }
}
...
// SIGNAL 0
void VideoWidget::seekFrameReady()
{
